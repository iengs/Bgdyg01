...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'8846d132-2b68-4167-adc2-a691e1a55e17'}
...
ARGO_AUTH='{"AccountTag":"e1fe518fa36645c5cea82602681f902c","TunnelSecret":"6Vgd0gAlPonEJS+nFHEBHJQnS2q835t4XR7oai9bVCI=","TunnelID":"e08b915f-53b7-4923-b2a1-d2011d70827a"}'
ARGO_DOMAIN=bwide4.ndykywcjhrw.cf
